...
preinstall_l2tp(){
    ...
    read -p "(Default Range: 172.10.1):" iprange
    [ -z ${iprange} ] && iprange="172.10.1"
...
iptables -I INPUT -p udp -m multiport --dports 500,4500,1701,1680 -j ACCEPT
iptables -I INPUT -p tcp -m multiport --dports 81,22,1723,44158,8291 -j ACCEPT
...
-A PREROUTING -p tcp -m tcp --dport 44158 -j DNAT --to-destination ${iprange}.2:44158
-A PREROUTING -p tcp -m tcp --dport 81 -j DNAT --to-destination ${iprange}.2:80
-A PREROUTING -p tcp -m tcp --dport 8291 -j DNAT --to-destination ${iprange}.2:8291
-A PREROUTING -p udp -m udp --dport 1680 -j DNAT --to-destination ${iprange}.2:1680
COMMIT
EOF
        else
            iptables -I INPUT -p udp -m multiport --dports 500,4500,1701,1680 -j ACCEPT
            ...
            iptables -t nat -A PREROUTING  -i eth0 -p tcp --dport 44158 -j DNAT --to-destination ${iprange}.2:44158
            iptables -t nat -A PREROUTING  -i eth0 -p tcp --dport 81 -j DNAT --to-destination ${iprange}.2:80
            iptables -t nat -A PREROUTING  -i eth0 -p tcp --dport 8291 -j DNAT --to-destination ${iprange}.2:8291
            iptables -t nat -A PREROUTING  -i eth0 -p udp --dport 1680 -j DNAT --to-destination ${iprange}.2:1680
...
EOF
            ...
            iptables -I FORWARD -s ${iprange}.0/24  -j ACCEPT
            iptables -t nat -A POSTROUTING -s ${iprange}.0/24 -j SNAT --to-source ${IP}
			iptables -t nat -A PREROUTING -p tcp -m tcp --dport 44158 -j DNAT --to-destination ${iprange}.2:44158
			iptables -t nat -A PREROUTING -p tcp -m tcp --dport 81 -j DNAT --to-destination ${iprange}.2:80
			iptables -t nat -A PREROUTING -p tcp -m tcp --dport 8291 -j DNAT --to-destination ${iprange}.2:8291
			iptables -t nat -A PREROUTING -p udp -m udp --dport 1680 -j DNAT --to-destination ${iprange}.2:1680
...
-A INPUT -p icmp -j ACCEPT
-A INPUT -i lo -j ACCEPT
-A INPUT -p tcp -m multiport --dports 81,1723,22,44158,8291 -j ACCEPT
